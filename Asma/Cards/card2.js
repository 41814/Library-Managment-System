...
const card2 = () => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}> WellCome to Library 2</Text>  {/* Title at the top */}
      <View style={styles.imageContainer}>
        
        <Image
          source={{ uri: 'https://images.pexels.com/photos/2908984/pexels-photo-2908984.jpeg?auto=compress&cs=tinysrgb&w=600' }}
          style={styles.image}
        />
      </View>
    </View>
