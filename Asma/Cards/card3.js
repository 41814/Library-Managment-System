...
const card3 = () => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}> WellCome to Library 4</Text>  {/* Title at the top */}
      <View style={styles.imageContainer}>
        
        <Image
          source={{ uri: 'https://images.pexels.com/photos/2793466/pexels-photo-2793466.jpeg?auto=compress&cs=tinysrgb&w=600' }}
          style={styles.image}
        />
      </View>
    </View>
