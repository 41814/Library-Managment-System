...
const card5 = () => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}> WellCome to Library 5</Text>  {/* Title at the top */}
      <View style={styles.imageContainer}>
        
        <Image
          source={{ uri: 'https://images.pexels.com/photos/1181570/pexels-photo-1181570.jpeg?auto=compress&cs=tinysrgb&w=600' }}
          style={styles.image}
        />
      </View>
    </View>
